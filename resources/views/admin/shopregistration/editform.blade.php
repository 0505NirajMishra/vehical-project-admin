    ...
    <div class="row mb-6">  
            ...
            <div class="col-lg-4 fv-row">
                ...
                @if($shopregistration->shop_id)
                    ...
                    <img src="{{ url('/') }}/vehicalcategory/image/{{$shopregistration->profile_image}}" height="50">
                @else
                    <input type="file" class="form-control form-control-lg form-control-solid" name="profile_image" accept=".png, .jpg, .jpeg">
                @endif
