        ...
        <div class="aside-logo flex-column-auto" id="kt_aside_logo">
            ...
            <a href="javascript:void(0)">
                <!-- <img alt="Logo"
                    ...
                    class="h-55px logo" /> -->
                    <h1 style="color:white">vehical</h1>
                </a>
            <!--end::Logo-->
            <!--begin::Aside toggler-->
                ...
                <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ checkActiveSideBar(['vehicaltype']) ? 'menu-item active' : '' }}"
                            href="{{ route('admin.vehicaltypes.index') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                            ...
                            <span class="menu-title">Vehical Type</span>
                        </a>
                    </div>

                    <div class="menu-item">
                        <a class="menu-link {{ checkActiveSideBar(['addservice']) ? 'menu-item active' : '' }}"
                            href="{{ route('admin.addservices.index') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ checkActiveSideBar(['vehicalemployee']) ? 'menu-item active' : '' }}"
                            href="{{ route('admin.vehicalemployees.index') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ checkActiveSideBar(['petroldesial']) ? 'menu-item active' : '' }}"
                            href="{{ route('admin.petroldesials.index') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <span class="menu-title">Petrol / Desiel</span>
                        </a>
                    </div>

                    <div class="menu-item">
                        <a class="menu-link {{ checkActiveSideBar(['flatbattery']) ? 'menu-item active' : '' }}"
                            href="{{ route('admin.flatbatterys.index') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <span class="menu-title">flat battery</span>
                        </a>
                    </div>

                    <div class="menu-item">
                        <a class="menu-link {{ checkActiveSideBar(['flattyre']) ? 'menu-item active' : '' }}"
                            href="{{ route('admin.flattyres.index') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <span class="menu-title">flat tyre</span>
                        </a>
                    </div>

                    <div class="menu-item">
                        <a class="menu-link {{ checkActiveSideBar(['addvehicaldetail']) ? 'menu-item active' : '' }}"
                            href="{{ route('admin.addvehicaldetails.index') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <span class="menu-title">add vehical detail</span>
                        </a>
                    </div>

                    <div class="menu-item">
                        <a class="menu-link {{ checkActiveSideBar(['shopregistration']) ? 'menu-item active' : '' }}"
                            href="{{ route('admin.shopregistrations.index') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <span class="menu-title">Shop Registration</span>
                        </a>
                    </div>
