        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-4 fv-row">
                @if($flatbattery->flatbattery_id )
                    ...
                    <img src="{{ url('/') }}/vehicalcategory/image/{{$flatbattery->vehical_image}}" height="50">
                @else
                    <input type="file" class="form-control form-control-lg form-control-solid" name="vehical_image" accept=".png, .jpg, .jpeg">
                @endif
            </div>
