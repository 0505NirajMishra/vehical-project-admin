...
<table class="table align-middle table-row-dashed fs-6 gy-5">
  ...
  <tr>
    ...
    <td>
        <a href="{{ url('/') }}/admin/petroldesials/active/{{$user->petrol_id}}/{{$user->status==0?1:($user->status==1?2:0)}}" data-id="`+ petrol_id +`" title="Status" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
